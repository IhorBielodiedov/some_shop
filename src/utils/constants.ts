...
export const PRODUCTS: Product[] = [
        ...
        variants: [
            {
                color: "Белый",
                price: 2490,
                photos: [movement_sensor_white_1, movement_sensor_white_2, movement_sensor_white_3],
                stock_quantity: 10,
                id: 0,
                is_favorite: false,
                description: 'Улавливает движение и запускает удобные сценарии освещения. Или передаёт, что в помещении кто-то есть.\n' +
                ...
                specifications: [
                    {
                        ...
                        rows: [
                            ...
                            { id: 1, name: "Дополнительная информация", value: "масса нетто (без батарейки): 18г; беспроводная связь: Zigbee 3.0; батарейка: CR2450, 3 В; измеряемые параметры: движение, освещение (только одновременно с движением); температура эксплуатации: -10˚ - +45˚С; допустимая влажность: 0 – 95% относительной влажности, без конденсации; рабочая частота: 2400 – 2483,5 МГц; комплектация: датчик движения и освещения, поворотное крепление, руководство пользователя, стикер для монтажа" },
                            { id: 2, name: "Работает в системе 'умный дом'", value: "есть" },
                            { id: 3, name: "Тип соединения устройств", value: "беспроводное" },
                            ...
                            { id: 9, name: "Способ монтажа", value: "накладн. на поверхность" },
        ...
        variants: [
            {
                ...
                id: 1001,
                is_favorite: false,
                description: 'Умная светодиодная лента Яндекса — с ней легко создавать дома атмосферное\n' +
                ...
                specifications: [
                    {
                        ...
                        title: "Общие",
                        rows: [
                            { id: 0, name: "Беспроводная связь", value: "Wi-Fi® 802.11 b/g/n (2,4 ГГц), Bluetooth® 5 (LE), Matter™" },
                            { id: 1, name: "Срок службы", value: "2 года" },
                            { id: 2, name: "Индекс цветопередачи", value: "Ra> 80" },
                            { id: 3, name: "Коэффициент пульсации", value: "< 1% (при максимальной яркости)" },
                            { id: 4, name: "Гарантия", value: "1 год" },
                            { id: 5, name: "Масса нетто", value: "0,3 кг" },
                            { id: 6, name: "Страна", value: "Китай" },
                            { id: 7, name: "Степень защиты", value: "Светодиодная лента - IP65 / Блок питания и контроллер - IP20" },
                            { id: 8, name: "Что в коробке", value: "Умная светодиодная лента Яндекса, адаптер питания, инструкция" },
                            { id: 9, name: "Габариты (длина х ширина)", value: "3м x 10 мм" },
                            { id: 10, name: "Максимальная длина с удлинителями", value: "10м" },
                            { id: 11, name: "Максимальная потребляемая мощность (3 м)", value: "8,2 Вт" },
                            { id: 12, name: "Световой поток (3м)", value: "до 750 лм" },
                            { id: 13, name: "Цвета свечения", value: "белый и цветной (RGB)" },
        ...
        variants: [
            {
                ...
                id: 100,
                is_favorite: false,
                description: 'Работает от батареек и может стать удобным дверным звонком или единственной кнопкой для запуска и выключения разных устройств. Компактную кнопку легко установить где угодно, будь то дверной косяк или прикроватный столик.',
                specifications: [
                    {
                        id: 0,
                        title: "Общие",
                        rows: [
                            ...
                            { id: 1, name: "Экосистема Умного дома", value: "Умный дом Яндекса" },
                            { id: 2, name: "Дополнительная информация", value: "габариты: 12 x 45 x 45 мм; масса нетто (без батарейки): 18г; беспроводная связь: Zigbee 3.0; батарейка: CR2032, 3 В; температура эксплуатации: -10˚ - +55˚С; допустимая влажность: 5 – 95% относительной влажности, без конденсации; рабочая частота: 2400 – 2483,5 МГц" },
                            { id: 3, name: "Особенности", value: "подключение к смартфону" },
                            { id: 4, name: "Тип соединения устройств", value: "беспроводное" },
                            ...
                            { id: 8, name: "Комплектация", value: "беспроводная кнопка, руководство пользователя, стикер для монтажа, кабель USB - micro USB" },
                            { id: 9, name: "Линейка", value: "Алиса" },
                            { id: 10, name: "Монтаж", value: "открытый" },
                            { id: 11, name: "Ориентация монтажа", value: "горизонтальная и вертикальная" },
        ...
        variants: [
            {
                ...
                id: 100,
                is_favorite: false,
                description: 'Умная розетка Яндекса с обновлённым дизайном сделает обычную домашнюю\n' +
                ...
                specifications: [
                    {
                        ...
                        title: "Общие",
                        rows: [
                            { id: 0, name: "Беспроводная связь", value: "WiFi® 802.11 b/g/n (2,4 ГГц), Bluetooth® 5 (LE)*, Matter™" },
                            { id: 1, name: "Срок службы", value: "2 года" },
                            ...
                            { id: 6, name: "Страна", value: "Китай" },
                            { id: 7, name: "Габариты (длина х ширина х высота)", value: "50 x 50 х 85 мм" },
                            { id: 8, name: "Максимальная нагрузка", value: "16А ~ 3680Вт (резистивный тип)" },
                            { id: 9, name: "Степень защиты", value: "IP 20" },
                            { id: 10, name: "Номинальная частота", value: "50 Гц" },
                            { id: 11, name: "Что в коробке", value: "Умная розетка Яндекса, инструкция" },
                        ]
                    }
                ]
            },
        ...
        variants: [
            {
                ...
                id: 100,
                is_favorite: false,
                description: "Универсальный Хаб Яндекса для простого и быстрого подключения разных приборов к умному дому с Алисой1. И единая точка управления всеми устройствами.\n" +
                ...
                specifications: [
                    {
                        ...
                        rows: [
                            ...
                            { id: 1, name: "Беспроводная связь", value: "Wi-Fi® IEEE 802.11b/g/n/ac (2,4 ГГц, 5 ГГц), Bluetooth® 5.0, BLE, Zigbee™ 3.0" },
                            { id: 2, name: "Разъемы и интерфейсы", value: "Ethernet - RJ-45, USB-C (только питание)" },
                            { id: 3, name: "Экосистема Умного дома", value: "Умный дом Яндекса" },
                            { id: 4, name: "Особенности", value: "инфракрасный пульт ДУ" },
                            { id: 5, name: "Габариты (диаметр x высота)", value: "90 x 26,5 мм" },
                            { id: 6, name: "Масса нетто", value: "135г" },
                            { id: 7, name: "Питание", value: "5 В c разъемом USB Type-C" },
                            { id: 8, name: "Входные характеристики", value: "номинальное напряжение: 100-240 В; номинальная частота: 50-60 Гц, максимальный ток: 500 мА;" },
                            { id: 9, name: "Инфракрасный передатчик и приемник", value: "есть" },
                            { id: 10, name: "Порт Ethernet 10/100M", value: "есть" },
                            { id: 11, name: "Адаптер питания модель", value: "Y7.5-S2C" },
                            { id: 12, name: "Выходные характеристики", value: "номинальное напряжение: 5 В, номинальный ток: 1,5 А" },
                            { id: 13, name: "Класс защиты", value: "2" },
                            { id: 14, name: "Температура эксплуатации", value: "+10˚ - +35˚С" },
                            { id: 15, name: "Допустимая влажность", value: "20 – 80% относительной влажности, без конденсации" },
                            { id: 16, name: "Комплектация", value: "хаб для устройств, адаптер питания и провод, руководство пользователя" },
                        ]
                    }
                ]
            }
            ...
            variants: [
                {
                    ...
                    id: 100,
                    is_favorite: false,
                    description: "Для комфортного и здорового микроклимата. Измеряет температуру и влажность в комнате и включает устройства умного дома, когда нужно. Беспроводной компактный датчик легко установить практически где угодно1. \n",
                    specifications: [
                        {
                            id: 0,
                            title: "Общие",
                            rows:  [
                                { id: 0, name: "Тип", value: "комнатный датчик температуры и влажности" },
                                { id: 1, name: "Экосистема Умного дома", value: "Zigbee™, Алиса" },
                                { id: 2, name: "Дополнительная информация", value: "масса нетто (без батарейки): 11г; беспроводная связь: Zigbee 3.0; батарейка: CR2032, 3 В; диапазон температуры и точность показаний: -10 … +50˚С, ±0,3˚С; диапазон влажности и точность показаний: 0-100% RH, ±3%; диапазон атмосферного давления и точность показаний: 30-110 кПа, ±12 кПа; температура эксплуатации: -20˚ - +50˚С; допустимая влажность: 0 – 100% относительной влажности; рабочая частота: 2400 – 2483,5 МГц; комплектация: датчик температуры и влажности, руководство пользователя, стикер для монтажа" },
                                { id: 3, name: "Тип соединения устройств", value: "беспроводное" },
                                ...
                                { id: 8, name: "Тип датчика", value: "датчик температуры и влажности" },
                                { id: 9, name: "Минимальное значение диапазона измерения (температура)", value: "-10 °C" },
                                { id: 10, name: "Максимальное значение диапазона измерения (температура)", value: "50 °C" },
                                { id: 11, name: "Диапазон измерения максимального значения влажности", value: "100" },
    ...
    {
        name: "Умная колонка",
        description: "Умная колонка Яндекс Станция Мини с часами с Алисой на YaGPT, 10Вт ",
        category_id: 3,
        discount: 1500,
        variants: [
            {
                color: "Синий сапфир",
                price: 9990,
                photos: [     blue_speaker_mini_10_1, blue_speaker_mini_10_2, blue_speaker_mini_10_3, blue_speaker_mini_10_4, blue_speaker_mini_10_5],
                stock_quantity: 20,
                id: 36,
                is_favorite: false,
                description: "Обновленная версия умной колонки с голосовым ассистентом Алисой.\n" +
                ...
                specifications: [
                    {
                        ...
                        title: "Общие",
                        rows: [
                            { id: 0, name: "Беспроводная связь", value: "Wi-Fi® 802.11b/g/n/ac (2,4 ГГц, 5 ГГц)" },
                            { id: 1, name: "Беспроводные интерфейсы", value: "Bluetooth® 5.0, BLE" },
                            { id: 2, name: "Динамик", value: "широкополосный, 10 Вт, 1 шт." },
                            { id: 3, name: "Микрофоны", value: "4 шт" },
                            { id: 4, name: "Адаптер питания", value: "Номинальное напряжение 100–240 В, Номинальная частота 50–60 Гц, Максимальный ток 500 мА, номинальное напряжение 15 В, номинальный ток 1,2 А, Класс защиты 2" },
                            { id: 5, name: "Сенсорные кнопки", value: "3" },
                            { id: 6, name: "Аудиовыход", value: "3.5 мм" },
                            { id: 7, name: "Разъём питания", value: "(DC jack) 4 мм" },
                            { id: 8, name: "Габариты и производство", value: "Гарантия: 1 год, Производство: Китай, Габариты (диаметр × высота): 97 × 54 мм, Масса нетто: 260 г." },
            ...
            },
            {
                ...
                price: 9990,
                photos: [    red_speaker_mini_10_1, red_speaker_mini_10_2, red_speaker_mini_10_3, red_speaker_mini_10_4, red_speaker_mini_10_5],
                stock_quantity: 20,
                id: 0,
                is_favorite: false,
                description: "Обновленная версия умной колонки с голосовым ассистентом Алисой.\n" +
            ...
            },
            {
                color: "Cерый опал",
                price: 9990,
                photos: [    gray_speaker_mini_10_1, gray_speaker_mini_10_2, gray_speaker_mini_10_3, gray_speaker_mini_10_4, gray_speaker_mini_10_5],
                stock_quantity: 20,
                id: 20,
                is_favorite: false,
                description: "Обновленная версия умной колонки с голосовым ассистентом Алисой.\n" +
            ...
            },
            {
                color: "Черный оникс",
                price: 9990,
                photos: [   black_speaker_mini_10_1, black_speaker_mini_10_2, black_speaker_mini_10_3, black_speaker_mini_10_4, black_speaker_mini_10_5],
                stock_quantity: 10,
                id: 2,
                is_favorite: false,
                description: "Обновленная версия умной колонки с голосовым ассистентом Алисой.\n" +
        ...
        variants: [
            {
                color: "Кобальт",
                price: 17990,
                photos: [ blue_speaker_2_1, blue_speaker_2_2, blue_speaker_2_3, blue_speaker_2_4, blue_speaker_2_5],
                stock_quantity: 10,
                id: 36,
                is_favorite: false,
                description: "Умная колонка второго поколения — новый дизайн, звук, центр управления умным домом и Алиса.\n" +
                    "Теперь Алиса работает с нейросетью YandexGPT, которая позволила улучшить сценарии работы виртуального ассистента №1*.\n" +
                ...
                specifications: [
                    {
                        ...
                        rows: [
                            ...
                            { id: 8, name: "Адаптер питания", value: "Входные характеристики: номинальное напряжение 100-240 В, номинальная частота 50-60 Гц, максимальный ток 0,9 А при 100 В, Выходные характеристики: 5 В / 3А, 9 В / 3A, 12 В / 2,92 А, 15 В / 2,33 А, Поддержка USB PD, Класс защиты: 2" },
                            { id: 9, name: "Верхняя панель", value: "99 x 123 мм, градиентная подсветка, 16 млн цветов, сенсорное управление" },
                            { id: 10, name: "Динамики", value: "2 широкополосных динамика по 63,5 мм, каждый мощностью 15 Вт, Суммарная акустическая мощность: 30 Вт, Диапазон частот: 65 Гц – 20 кГц" },
                        ]
                    }
                ]
            },
            {
                color: "Антрацит",
                price: 17990,
                photos: [   black_speaker_2_1, black_speaker_2_2, black_speaker_2_3, black_speaker_2_4, black_speaker_2_5],
                stock_quantity: 10,
                id: 2,
                is_favorite: false,
                description: "Умная колонка второго поколения — новый дизайн, звук, центр управления умным домом и Алиса.\n" +
            ...
            },
            {
                color: "Медный",
                price: 17990,
                photos: [   brown_speaker_2_1, brown_speaker_2_2, brown_speaker_2_3, brown_speaker_2_4, brown_speaker_2_5],
                stock_quantity: 10,
                id: 50,
                is_favorite: false,
                description: "Умная колонка второго поколения — новый дизайн, звук, центр управления умным домом и Алиса.\n" +
            ...
            },
            {
                color: "Песочный",
                price: 17990,
                photos: [    sandy_speaker_2_1, sandy_speaker_2_2, sandy_speaker_2_3, sandy_speaker_2_4, sandy_speaker_2_5],
                stock_quantity: 10,
                id: 51,
                is_favorite: false,
                description: "Умная колонка второго поколения — новый дизайн, звук, центр управления умным домом и Алиса.\n" +
        ...
        variants: [
            {
                color: "Фиолетовый",
                price: 5990,
                photos: [   purple_speaker_light_2_1, purple_speaker_light_2_2, purple_speaker_light_2_3],
                stock_quantity: 10,
                id: 30,
                is_favorite: false,
                ...
                specifications: [
                    {
                        ...
                        rows: [
                            ...
                            { id: 2, name: "Беспроводные интерфейсы", value: "Bluetooth®, Wi-Fi®" },
                            { id: 3, name: "Комплектация", value: "Яндекс Станция Лайт 2, адаптер питания, инструкция" },
            ...
            },
            {
                color: "Голубой",
                price: 5990,
                photos: [   blue_speaker_light_2_1, blue_speaker_light_2_2, blue_speaker_light_2_3],
                stock_quantity: 10,
                id: 35,
                is_favorite: false,
                description: "Яндекс Станция Лайт 2 — новая умная колонка для детей и тех, кто не перестаёт ими быть. Внутри живёт более эмоциональная и функциональная Алиса, с которой никогда не бывает скучно: с ней можно веселиться, делиться секретами, играть и общаться дни напролёт — она найдет ответы на миллионы вопросов, придумает идеи, предложит классные игры, включит любимую музыку. Теперь виртуальный ассистент №1⁵ подстраивает интонацию под ваше настроение и показывает свои эмоции с помощью глазок на LED-экране Станции. В наборе — классные стикеры и маски, чтобы у ребёнка было пространство для творчества.",
            ...
            },
            {
                color: "Розовый",
                price: 5990,
                photos: [pink_speaker_light_2_1, pink_speaker_light_2_2, pink_speaker_light_2_3],
                stock_quantity: 10,
                id: 40,
                is_favorite: false,
                description: "Яндекс Станция Лайт 2 — новая умная колонка для детей и тех, кто не перестаёт ими быть. Внутри живёт более эмоциональная и функциональная Алиса, с которой никогда не бывает скучно: с ней можно веселиться, делиться секретами, играть и общаться дни напролёт — она найдет ответы на миллионы вопросов, придумает идеи, предложит классные игры, включит любимую музыку. Теперь виртуальный ассистент №1⁵ подстраивает интонацию под ваше настроение и показывает свои эмоции с помощью глазок на LED-экране Станции. В наборе — классные стикеры и маски, чтобы у ребёнка было пространство для творчества.",
    ...
    {
        name: "Умная колонка",
        description: "Умная колонка Яндекс Станция Миди с Алисой на YaGPT, с Zigbee™, 24Вт ",
        category_id: 3,
        discount: 0,
        variants: [
                ...
                specifications: [
                    {
                        ...
                        rows:  [
                            ...
                            { id: 2, name: "Минимальная воспроизводимая частота", value: "70 Гц" },
                            { id: 3, name: "Максимальная воспроизводимая частота", value: "20 кГц" },
                            { id: 4, name: "Количество динамиков", value: "ВЧ x 2, НЧ x 1, пассивн. излучатель x 2" },
                            { id: 5, name: "Диаметр НЧ-динамика", value: "63 мм" },
                            { id: 6, name: "Количество микрофонов", value: "4" },
                            { id: 7, name: "Беспроводная связь", value: "Bluetooth®, Wi-Fi®, Zigbee™" },
                            { id: 8, name: "Стандарт Wi-Fi", value: "IEEE 802.11 a/b/g/n/ac" },
                            { id: 9, name: "Частотный диапазон Wi-Fi", value: "2.4 ГГц / 5 ГГц" },
                            ...
                            { id: 13, name: "Экосистема Умного дома", value: "Умный дом Яндекса" },
                            { id: 14, name: "Дополнительная информация", value: "монохромный LED-дисплей, 45 сегментов, круговая LED-подсветка, 16 млн цветов, сенсорная модель управления, NPU-процессор производительностью 1.2 TOPS, поддержка USB PD" },
                            { id: 15, name: "Особенности", value: "поддержка потоковых аудиосервисов" },
            ...
            },
            {
                color: "Черный",
                price: 16990,
                photos: [    black_speaker_zigbee_24_1, black_speaker_zigbee_24_2, black_speaker_zigbee_24_3],
                stock_quantity: 10,
                id: 2,
                is_favorite: false,
                description: "Яндекс Станция Миди — новая умная колонка с виртуальным ассистентом Алисой. Мощное звучание 24 Вт в таком компактном корпусе. Благодаря переходу на нейронный процессор Станция Миди быстрее обрабатывает ваши запросы. А значит, Алиса лучше откликается на команды и точнее узнаёт людей по голосу. LED-дисплей, который показывает время, погоду и реакции Алисы, а также активная контурная LED-подсветка. Встроенный хаб управления Zigbee™ и голосовое управление умным домом даже без интернета1. Беспроводная связь Wi-Fi (2,4–5 ГГц) и Bluetooth 5.0.\n" +
            ...
            },
            {
                color: "Изумрудная",
                price: 16990,
                photos: [   green_speaker_zigbee_24_1, green_speaker_zigbee_24_2, green_speaker_zigbee_24_3],
                stock_quantity: 10,
                id: 25,
                is_favorite: false,
                description: "Яндекс Станция Миди — новая умная колонка с виртуальным ассистентом Алисой. Мощное звучание 24 Вт в таком компактном корпусе. Благодаря переходу на нейронный процессор Станция Миди быстрее обрабатывает ваши запросы. А значит, Алиса лучше откликается на команды и точнее узнаёт людей по голосу. LED-дисплей, который показывает время, погоду и реакции Алисы, а также активная контурная LED-подсветка. Встроенный хаб управления Zigbee™ и голосовое управление умным домом даже без интернета1. Беспроводная связь Wi-Fi (2,4–5 ГГц) и Bluetooth 5.0.\n" +
            ...
            },
            {
                color: "Красная",
                price: 16990,
                photos: [     red_speaker_zigbee_24_1, red_speaker_zigbee_24_2, red_speaker_zigbee_24_3],
                stock_quantity: 10,
                id: 0,
                is_favorite: false,
                description: "Яндекс Станция Миди — новая умная колонка с виртуальным ассистентом Алисой. Мощное звучание 24 Вт в таком компактном корпусе. Благодаря переходу на нейронный процессор Станция Миди быстрее обрабатывает ваши запросы. А значит, Алиса лучше откликается на команды и точнее узнаёт людей по голосу. LED-дисплей, который показывает время, погоду и реакции Алисы, а также активная контурная LED-подсветка. Встроенный хаб управления Zigbee™ и голосовое управление умным домом даже без интернета1. Беспроводная связь Wi-Fi (2,4–5 ГГц) и Bluetooth 5.0.\n" +
            ...
            },
            {
                color: "Желтая",
                price: 16990,
                photos: [    yellow_speaker_zigbee_24_1, yellow_speaker_zigbee_24_2, yellow_speaker_zigbee_24_3],
                stock_quantity: 10,
                id: 99,
                is_favorite: false,
                description: "Яндекс Станция Миди — новая умная колонка с виртуальным ассистентом Алисой. Мощное звучание 24 Вт в таком компактном корпусе. Благодаря переходу на нейронный процессор Станция Миди быстрее обрабатывает ваши запросы. А значит, Алиса лучше откликается на команды и точнее узнаёт людей по голосу. LED-дисплей, который показывает время, погоду и реакции Алисы, а также активная контурная LED-подсветка. Встроенный хаб управления Zigbee™ и голосовое управление умным домом даже без интернета1. Беспроводная связь Wi-Fi (2,4–5 ГГц) и Bluetooth 5.0.\n" +
    ...
    {
        name: "Умная колонка",
        description: "Умная колонка Яндекс Станция Макс с Алисой на YaGPT, с Zigbee™, 65Вт ",
        category_id: 3,
        discount: 0,
        variants: [
            {
                color: "Зеленый",
                price: 34990,
                photos: [  green_speaker_zigbee_65_1, green_speaker_zigbee_65_2, green_speaker_zigbee_65_3],
                stock_quantity: 10,
                id: 15,
                is_favorite: false,
                description: "Умная колонка Яндекс Станция Макс с виртуальным ассистентом Алисой, мощным звучанием и встроенным хабом управления Zigbee, мощностью звучания 65 Вт, встроенным хабом управления Zigbee, беспроводной связью Wi-Fi (2,4–5 ГГц) и Bluetooth 5.0, с возможностью встраивания в экосистему умного дома — от официального поставщика с гарантией от производителя.\n" +
                    "Теперь Алиса работает с нейросетью YandexGPT, которая позволила улучшить сценарии работы виртуального ассистента №1*.\n" +
                    "Помогает вам придумывать идеи, объясняет сложное простыми словами, общается как интересный собеседник -  теперь Алиса лучше удерживает контекст разговора и задаёт вопросы, когда хочет что-то уточнить.\n" +
                    "\n",
                specifications: [
                    {
                        ...
                        rows:  [
                            ...
                            { id: 1, name: "Мощность", value: "65 Вт, 2 Hi-Fi усилителя класса D" },
                            { id: 2, name: "Гарантия", value: "1 год" },
                            { id: 3, name: "Масса нетто", value: "2,6 – 3 кг (4,175кг в коробке с аксессуарами. Устройство без аксессуаров – 2,65кг)" },
                            { id: 4, name: "Комплектация", value: "Яндекс Станция Макс, адаптер питания, пульт, кабель HDMI, кабель Ethernet, инструкция" },
                            { id: 5, name: "Входные характеристики", value: "Номинальное напряжение 100-240 В, Номинальная частота 50-60 Гц, максимальный ток 1,8 А" },
                            { id: 6, name: "Выходные характеристики", value: "номинальное напряжение 20 В, номинальный ток 3,25 А" },
                            { id: 7, name: "Производство", value: "Китай" },
                            { id: 8, name: "Трёхполосный звук", value: "Низкие, средние и высокие частоты играют разные динамики, чтобы слышать каждый инструмент" },
                            { id: 9, name: "5 динамиков + 1 пассивный излучатель", value: "НЧ: 1 шт., до 40 Вт, 88 мм (направлен в сторону), СЧ: 2 шт., до 10 Вт, 38 мм (направлены в сторону, фазоинвертеры направлены вперед), ВЧ: 2 шт., до 15 Вт, 20 мм (на фронтальной поверхности), ПИ: 1 шт., 120*95 мм (направлен в сторону)" },
                            { id: 10, name: "Технология Dolby Audio", value: "есть" },
                            { id: 11, name: "Диапазон частот", value: "45 – 20 000 Гц" },
                            { id: 12, name: "Подключение к ТВ", value: "4K (поддержка потоковых видеосервисов), HDMI 2 (кабель в комплекте), Пульт ДУ (в комплекте): - Bluetooth 4.2 - BLE - 2 батарейки ААА - дальность действия – до 10м" },
                            { id: 13, name: "Другие характеристики", value: "7 микрофонов, Встроенный голосовой помощник Алиса, LED-экран монохромный, белый (25x16 пикселей), Аудиовыход AUX 3,5 мм – для подключения к внешней акустике, Питание от сети, Адаптер питания (в комплекте)" },
                            { id: 14, name: "Мультирум", value: "Поставьте по колонке с Алисой в каждой комнате, и все они будут играть в унисон – и маленькие, и большие – и Станция Макс" },
                            { id: 15, name: "Wi-Fi 802.11 b/g/n/ac (2,4 и 5 ГГц)", value: "да" },
                            { id: 16, name: "Zigbee", value: "да" },
                            { id: 17, name: "Gigabit Ethernet (кабель в комплекте)", value: "да" },
                            { id: 18, name: "Габариты устройства (Г x Ш x В)", value: "141 x 141 x 231 мм" },
                        ]
                    }
                ]
            },
            {
                color: "Бежевый",
                price: 34990,
                photos: [beige_speaker_zigbee_65_1, beige_speaker_zigbee_65_2, beige_speaker_zigbee_65_3],
                stock_quantity: 10,
                id: 10,
                is_favorite: false,
                description: "Умная колонка Яндекс Станция Макс с виртуальным ассистентом Алисой, мощным звучанием и встроенным хабом управления Zigbee, мощностью звучания 65 Вт, встроенным хабом управления Zigbee, беспроводной связью Wi-Fi (2,4–5 ГГц) и Bluetooth 5.0, с возможностью встраивания в экосистему умного дома — от официального поставщика с гарантией от производителя.\n" +
            ...
            },
            {
                color: "Черный",
                price: 34990,
                photos: [  black_speaker_zigbee_65_1, black_speaker_zigbee_65_2, black_speaker_zigbee_65_3],
                stock_quantity: 10,
                id: 2,
                is_favorite: false,
                description: "Умная колонка Яндекс Станция Макс с виртуальным ассистентом Алисой, мощным звучанием и встроенным хабом управления Zigbee, мощностью звучания 65 Вт, встроенным хабом управления Zigbee, беспроводной связью Wi-Fi (2,4–5 ГГц) и Bluetooth 5.0, с возможностью встраивания в экосистему умного дома — от официального поставщика с гарантией от производителя.\n" +
    ...
    {
        name: "Умная колонка",
        description: "Умная колонка Яндекс Станция Дуо Макс с Алисой на YaGPT, с Zigbee™, 60Вт ",
        category_id: 3,
        discount: 0,
        variants: [
            {
                ...
                specifications: [
                    {
                        ...
                        rows:  [
                            ...
                            { id: 2, name: "Минимальная воспроизводимая частота", value: "60 Гц" },
                            { id: 3, name: "Максимальная воспроизводимая частота", value: "20 кГц" },
                            { id: 4, name: "Количество динамиков", value: "НЧ x 1, широкополосн. x 2" },
                            { id: 5, name: "Диаметр НЧ-динамика", value: "100 мм" },
                            { id: 6, name: "Количество микрофонов", value: "8" },
                            { id: 7, name: "Беспроводная связь", value: "Bluetooth®, Wi-Fi®, Zigbee™" },
                            { id: 8, name: "Стандарт Wi-Fi", value: "IEEE 802.11 b/g/n/ac/ax" },
                            { id: 9, name: "Частотный диапазон Wi-Fi", value: "2.4 ГГц / 5 ГГц" },
                            { id: 10, name: "Стандарт Bluetooth", value: "5.2/BLE" },
                            { id: 11, name: "Тип питания", value: "от сети, От сети 220 В" },
                            { id: 12, name: "Материал корпуса", value: "пластик, ткань" },
                            { id: 13, name: "Экосистема Умного дома", value: "Умный дом Яндекса" },
                            { id: 14, name: "Особенности", value: "поддержка потоковых аудиосервисов, поддержка потоковых видеосервисов" },
                            ...
                            { id: 23, name: "Входные характеристики", value: "номинальное напряжение 100–240 В, номинальная частота 50–60 Гц, максимальный ток 1,8 А" },
                            { id: 24, name: "выходные характеристики", value: "5 B / 3 A; 9 B / 3 A; 15 B / 3 A; 20 B / 3,25 A, поддержка USB PD 3.0" },
            ...
            },
            {
                color: "Зеленый",
                price: 44990,
                photos: [green_speaker_zigbee_60_1, green_speaker_zigbee_60_2, green_speaker_zigbee_60_3, green_speaker_zigbee_60_4, green_speaker_zigbee_60_5],
                stock_quantity: 10,
                id: 15,
                is_favorite: false,
                description: "Яндекс Станция Дуо Макс с Алисой — новая флагманская умная колонка с экраном. Большой поворотный Full HD touch-экран с камерой, чтобы смотреть фильмы¹, общаться с близкими по видеосвязи, видеть ответы Алисы и управлять умным домом касаниями. Мощные динамики и сабвуфер — для чистого и сбалансированного звучания любимой музыки¹. Контурная анимированная LED-подсветка. Встроенный хаб управления Zigbee™². Продуманный до деталей дизайн, чтобы вы получали удовольствие каждый раз, когда взаимодействуете с колонкой или просто на неё смотрите.\n",
            ...
            },
            {
                color: "бежевый",
                price: 44990,
                photos: [beige_speaker_zigbee_60_1, beige_speaker_zigbee_60_2, beige_speaker_zigbee_60_3, beige_speaker_zigbee_60_4, beige_speaker_zigbee_60_5],
                stock_quantity: 10,
                id: 10,
                is_favorite: false,
                description: "Яндекс Станция Дуо Макс с Алисой — новая флагманская умная колонка с экраном. Большой поворотный Full HD touch-экран с камерой, чтобы смотреть фильмы¹, общаться с близкими по видеосвязи, видеть ответы Алисы и управлять умным домом касаниями. Мощные динамики и сабвуфер — для чистого и сбалансированного звучания любимой музыки¹. Контурная анимированная LED-подсветка. Встроенный хаб управления Zigbee™². Продуманный до деталей дизайн, чтобы вы получали удовольствие каждый раз, когда взаимодействуете с колонкой или просто на неё смотрите.\n",
            ...
            },
            {
                color: "Красный",
                price: 44990,
                photos: [red_speaker_zigbee_60_1, red_speaker_zigbee_60_2, red_speaker_zigbee_60_3, red_speaker_zigbee_60_4, red_speaker_zigbee_60_5],
                stock_quantity: 10,
                id: 0,
                is_favorite: false,
                description: "Яндекс Станция Дуо Макс с Алисой — новая флагманская умная колонка с экраном. Большой поворотный Full HD touch-экран с камерой, чтобы смотреть фильмы¹, общаться с близкими по видеосвязи, видеть ответы Алисы и управлять умным домом касаниями. Мощные динамики и сабвуфер — для чистого и сбалансированного звучания любимой музыки¹. Контурная анимированная LED-подсветка. Встроенный хаб управления Zigbee™². Продуманный до деталей дизайн, чтобы вы получали удовольствие каждый раз, когда взаимодействуете с колонкой или просто на неё смотрите.\n",
        ...
        variants: [
            {
                ...
                id: 2,
                is_favorite: false,
                description: "ТВ Станция — новый умный телевизор Яндекса, объединивший в себе лучшие технологии телевизоров и умных колонок с Алисой.\n" +
                ...
                specifications: [
                    {
                        ...
                        rows: [
                            ...
                            { id: 2, name: "Разъемы и интерфейсы", value: "Ethernet - RJ-45, USB Type-A x 2, вход HDMI x 3, выход аудио цифровой оптический, композитный видеовход" },
                            { id: 3, name: "Экосистема Умного дома", value: "Умный дом Яндекса" },
                            { id: 4, name: "Дополнительная информация", value: "Пульт в комплекте, Поддержка Apple HomeKit - нет, Запись с ТВ на USB устройство - нет, Аналоговый тюнер PAL/SECAM - нет, Стандарты DVB-C, DVB-C2, DVB-S, DVB-S2, DVB-T, DVB-T2 - нет" },
                            ...
                            { id: 18, name: "Беспроводные интерфейсы", value: "Bluetooth®, Wi-Fi®" },
                            { id: 19, name: "Платформа Smart TV", value: "YaOS X" },
                            { id: 20, name: "Особенности", value: "Local Dimming, Time Shift, голосовое управление, запись ТВ программ, защита от детей, таймер сна, телетекст, электронный Телегид, hdr, ТВ-тюнер отсутствует" },
                            ...
                            { id: 28, name: "Тип соединения устройств", value: "беспроводное" },
                            { id: 29, name: "Размеры с подставкой (ШxВxГ)", value: "966x638x311 мм" },
                            { id: 30, name: "Вес с подставкой", value: "8.8 кг" },
                            { id: 31, name: "Размеры без подставки (ШxВxГ)", value: "966x578x84 мм" },
        ...
        variants: [
            {
                ...
                id: 2,
                is_favorite: false,
                description: "ТВ Станция Про — новый умный телевизор Яндекса, объединивший в себе лучшие технологии телевизоров и умных колонок с Алисой.\n" +
                ...
                specifications: [
                    {
                        ...
                        rows: [
                            ...
                            { id: 2, name: "Разъемы и интерфейсы", value: "Ethernet - RJ-45, USB Type-A x 2, вход HDMI x 3, выход аудио цифровой оптический" },
                            { id: 3, name: "Экосистема Умного дома", value: "Умный дом Яндекса" },
                            { id: 4, name: "Дополнительная информация", value: "Кронштейн в комплекте, Пульт в комплекте, Поддержка Apple HomeKit - нет, Запись с ТВ на USB устройство - нет, Аналоговый тюнер PAL/SECAM - нет, Стандарты DVB-C, DVB-C2, DVB-S, DVB-S2, DVB-T, DVB-T2 - нет" },
                            ...
                            { id: 27, name: "Работает в системе 'умный дом'", value: "есть" },
                            { id: 28, name: "Тип соединения устройств", value: "беспроводное" },
                            { id: 29, name: "Размеры с подставкой (ШxВxГ)", value: "1449x909x328 мм" },
                            { id: 30, name: "Вес с подставкой", value: "19.1 кг" },
                            { id: 31, name: "Размеры без подставки (ШxВxГ)", value: "1449x848x40 мм" },
        ...
        variants: [
            {
                ...
                id: 2,
                is_favorite: false,
                description: "Автоматизировать бытовую технику при помощи умного пульта Yandex SmartControl YNDX-0006 проще, чем может показаться.\n" +
                ...
                specifications: [
                    {
                        ...
                        rows: [
                            ...
                            { id: 1, name: "Экосистема Умного дома", value: "Умный дом Яндекса" },
                            { id: 2, name: "Дополнительная информация", value: "беспроводная связь: Wi-Fi 802.11b/g/n (2,4 ГГц); инфракрасные приёмопередатчики: 7 шт., 38 кГц; сетевой адаптер не входит в комплект; функции - дистанционное управление техникой, включение/отключение приборов по расписанию; возможность одновременного подключения до 301 устройства" },
                            { id: 3, name: "Беспроводные интерфейсы", value: "Wi-Fi®, ИК" },
                            { id: 4, name: "Тип соединения устройств", value: "беспроводное" },
                            { id: 5, name: "Протокол связи Умного дома", value: "Wi-Fi®, ИК-порт" },
                            { id: 6, name: "Ширина", value: "65 мм" },
                            { id: 7, name: "Высота", value: "25 мм" },
                            { id: 8, name: "Вес", value: "100 г" },
                            { id: 9, name: "Тип пульта", value: "умный" },
                            { id: 10, name: "Настройка пульта ДУ", value: "мобильное приложение" },
                            { id: 11, name: "Питание", value: "разъем micro USB (5 В)" },
                            { id: 12, name: "Опции и комплект", value: "голосовое управление" },
                ...
                specifications: [
                    {
                        ...
                        rows: [
                            ...
                            { id: 17, name: "Беспроводные интерфейсы", value: "Bluetooth®, Wi-Fi®" },
                            ...
                            { id: 27, name: "Тип соединения устройств", value: "беспроводное" },
                            { id: 28, name: "Размеры с подставкой (ШxВxГ)", value: "1228x784x328 мм" },
                            { id: 29, name: "Вес с подставкой", value: "19.1 кг" },
                            { id: 30, name: "Размеры без подставки (ШxВxГ)", value: "1228x722x40 мм" },
        ...
        variants: [
            {
                ...
                id: 2,
                is_favorite: false,
                description: "Лампа подключается по Wi-Fi через приложение Яндекс и может управляться с помощью голосового помощника Алисы, поэтому каждый со смартфоном или планшетом в руках сможет удаленно управлять цветовой температурой от 2700 до 6500 К, и настраивать сценарии работы при определенных условиях1.\n" +
                    "\n" +
                ...
                specifications: [
                    {
                        ...
                        title: "Общие",
                        rows: [
                            { id: 0, name: "Беспроводная связь", value: "Wi-Fi® 802.11b/g/n (2,4 ГГц)" },
                            ...
                            { id: 15, name: "Цветовая температура", value: "2700-6500К, RGB+W" },
                            { id: 16, name: "Габариты (диаметр x высота)", value: "39 x 118 мм" },
                            { id: 17, name: "Питание", value: "220-240 В, 50-60 Гц, 0,0,4 А" },
        ...
        variants: [
            {
                ...
                id: 2,
                is_favorite: false,
                description: "Компактный беспроводный датчик реагирует на открытие дверей и окон. Свяжите датчик с разными устройствами и создавайте сценарии в приложении Дом с Алисой1. Проверяйте в приложении, закрыты ли дома окна. А ещё можно связать датчик с кондиционером — и он будет сам выключаться, когда вы проветриваете комнату.",
                specifications: [
                    {
                        id: 0,
                        title: "Общие",
                        rows: [
                            ...
                            {id: 2, name: "Экосистема Умного дома", value: "Умный дом Яндекса"},
                            {id: 3, name: "Тип соединения устройств", value: "беспроводное"},
                            ...
                            {id: 10, name: "Способ монтажа", value: "накладн. на поверхность"},
                            ...
                            {id: 14, name: "Протокол связи", value: "Zigbee™"},
                            {
                                id: 15,
                                name: "Комплектация",
                                value: "датчик открытия дверей и окон, руководство пользователя, стикеры для монтажа"
                            },
                            {id: 16, name: "температура эксплуатации", value: "-10˚ - +50˚С"},
                            {
                                id: 17,
                            ...
                            {id: 20, name: "тип сенсора", value: "герметизированный контакт (геркон)"},
                            {id: 21, name: "максимальная дистанция сработки сенсора", value: "22 мм"},
        ...
        variants: [
            {
                ...
                id: 2,
                is_favorite: false,
                description: "Можно одной фразой включить, выключить свет или удалённо настроить освещение Яндекс1.\n" +
                    "\n" +
                ...
                specifications: [
                    {
                        ...
                        rows: [
                            ...
                            {id: 3, name: "Напряжение", value: "220-240 В, 50-60 Гц, 0,07 А"},
                            {id: 4, name: "Световой поток", value: "до 400 лм"},
                            {id: 5, name: "Световая отдача", value: "81,6 лм/Вт"},
                            {id: 6, name: "Цветовая температура", value: "2700-6500К, RGB+W"},
                            ...
                            {id: 15, name: "Возможность дистанционного управления", value: "есть"},
        ...
        variants: [
            {
                ...
                id: 2,
                is_favorite: false,
                description: "Умная Яндекс. Лампа позволяет дистанционно управлять освещением в комнате или доме. Поддержка Wi-Fi позволяет лампе работать в системе «умный дом» Яндекса и реагировать на команды, отданные по мобильному приложению или напрямую голосовому помощнику Алисе.",
                specifications: [
                    {
                        id: 0,
                        title: "Общие",
                        rows: [
                            ...
                            {id: 13, name: "Габариты (диаметр x высота)", "value": "55x120 мм"},
                            {id: 14, name: "Максимальная выходная мощность", "value": "17,41 дБм"},
                            {id: 15, name: "Питание", "value": "220-240 В, 50-60 Гц, 0,08 А"},
                            {id: 16, name: "Рабочий диапазон частот", "value": "2412-2472 МГц"}
                        ]
                    }
                ]
            }
    ...
    },
    {
        name: "Умная лампочка",
        description:
            "Умная лампочка Яндекс, цоколь E27, 8 Вт, ",
        category_id: 1,
        discount: 300,
        variants: [
            {
                ...
                specifications: [
                    {
                        ...
                        rows: [
                            ...
                            {id: 4, name: "Напряжение", value: "220-240 В, 50-60 Гц, 0,07 А"},
                            ...
                            {id: 16, name: "Габариты (диаметр x высота)", value: "60x110 мм"},
        ...
        variants: [
            {
                ...
                id: 0,
                is_favorite: false,
                description: "Умная колонка Яндекс Станция 2 с Алисой на YaGPT, 30 Вт. Умная\n" +
